...
//		}
//		
//		List<WebElement> prices = driver.findElements(By.xpath("//*[@class='sx-price sx-price-large']"));
...
//		}
		...
		System.out.println("Whole item size is "+ wholeItems.size());
